    ...
    try {
      ...
      if(!args[0])
        return message.reply({embeds :[new MessageEmbed()
          .setColor(es.wrongcolor)
          .setFooter(client.getFooter(es))
          .setTitle(`<:Wrong:955323096640921632> **You forgot to add a Cooldown amount**`)
      ...
      message.reply({embeds :[new MessageEmbed()
        .setColor(es.color)
        .setFooter(client.getFooter(es))
        .setTitle(`<a:Tick:955323097915994164> **Successfully changed the autoarchive Duration to \`${duration}\` of ${channel.name}**`)
      ]});
