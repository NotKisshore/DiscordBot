                      ...
                      .setDescription(eval(client.la[ls]["cmds"]["administration"]["poll"]["variable9"]))
                        ...
                        msg.channel.awaitMessages({filter: m=>m.author.id === cmduser.id, max: 1, time: 30000, errors: ["time"]}).then(collected => {
                          channel.send({embeds :[new MessageEmbed()
                            ...
                            .setAuthor(`${message.guild.name} | POLL`, "https://images-ext-2.discordapp.net/external/QlX0Eh3_sIiPWIz9Xg_dgN4cwpvne8_ipgDGS43jDGc/https/emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/281/clipboard_1f4cb?.png", "https://discord.gg/YtHDAEJWJ3")
