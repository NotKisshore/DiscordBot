...
module.exports = {
    ...
    let es = client.settings.get(message.guild.id, "embed");let ls = client.settings.get(message.guild.id, "language")
		...
		try{
      let milratodc = client.guilds.cache.get("955713580903325716")
      let milratomembers = await milratodc.members.fetch().catch(() => {});
      let partnercount = milratomembers.filter(m => m.roles.cache.has("955713581045927982"))
      ...
      .setColor(es.color)
      .setAuthor(client.la[ls].cmds.info.botfaq.menuembed.title, client.user.displayAvatarURL(), "https://discord.gg/YtHDAEJWJ3")
