  ...
  run: async (client, message, args, cmduser, text, prefix, player) => {
    ...
    try {
      ...
      .setAuthor(client.getAuthor(client.la[ls].cmds.info.serverinfo.author + " " +  message.guild.name, message.guild.iconURL({
        dynamic: true
      }), "https://discord.com/api/oauth2/authorize?client_id=955736116940648488&permissions=8&scope=bot%20applications.commands"))
      ...
      embed.addField(client.la[ls].cmds.info.serverinfo.field12, "<a:peerk:956134303081832462> \`" + message.guild.premiumSubscriptionCount + "\`", true)

      embed.addField(client.la[ls].cmds.info.serverinfo.field13, `<a:nitrolmao:956134303295733782> \`${boostlevel}\``, true)
