  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      translate(args.slice(2).join(" "), {from: args[0], to: args[1]}).then(res=>{
        ...
        .setColor(es.color)
        .setAuthor(handlemsg(client.la[ls].cmds.info.translate.to, { to: args[1] }), "https://cdn.discordapp.com/avatars/955747177785876480/1b508a89f792bd49c1aaae871bda5a7b.webp", "https://discord.gg/YtHDAEJWJ3")
