    ...
    try {
      ...
      async function first_layer(){
        ...
        let MenuEmbed = new Discord.MessageEmbed()
          .setColor(es.color)
          .setAuthor('Auto Delete Setup', 'https://cdn.discordapp.com/emojis/834052497492410388.gif?size=96', 'https://discord.gg/YtHDAEJWJ3')
              ...
              .then(collected => {
                ...
                if (channel) {
                  try {
                    ...
                    if(!time || isNaN(time))
                      return message.reply({embeds: [new Discord.MessageEmbed()
                        .setTitle(`<:Wrong:955323096640921632> Invalid Input | Time wrong`)
                    ...
                    if(time > 60*60 || time < 3)
                      return message.reply({embeds: [new Discord.MessageEmbed()
                        .setTitle(`<:Wrong:955323096640921632> Time out of Range!`)
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      .setTitle(`<a:Tick:955323097915994164> I will now delete Messages after \`${time} Seconds\` in **${channel.name}**`)
                      .setColor(es.color)
                      .setFooter(client.getFooter(es))
                    ]});
                  } catch (e) {
              ...
              .then(collected => {
                ...
                if (channel) {
                  try {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      .setTitle(`<a:Tick:955323097915994164> Successfully removed **${channel.name}** out of the Setup!`)
                      .setColor(es.color)
                      .setFooter(client.getFooter(es))
                    ]});
                  } catch (e) {
