  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      //YEA
        ...
        let crimemsgarray = ["You robbed the Local Bank **Noice**", "You destroyed the neighbour's mailbox", "You stolen a 24k Clock from the Shop", 
            "You robbed Döner from NotKisshore", "You kidnapped the sister of your stepmom", "You were driving to fast and escaped the police",
            "You cracked Discord Nitro *is it possible?*", "You stole Discord Nitros *bruh*", "You hacked the local Network **careful from the police**", "You hacked the electricity of your town Lmfao",
            "You crashed TikTok", "You stole Corona Tests Lmao", "You stole Masks ||Is that enough for you?||"
        ];
